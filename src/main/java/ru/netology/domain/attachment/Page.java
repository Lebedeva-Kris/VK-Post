...
public class Page {
    ...
    private int getCurrentUserCanEditAccess;
    ...
    public int getGetCurrentUserCanEditAccess() {
        return getCurrentUserCanEditAccess;
    }
    public void setGetCurrentUserCanEditAccess(int getCurrentUserCanEditAccess) {
        this.getCurrentUserCanEditAccess = getCurrentUserCanEditAccess;
    }
